...
public class BiomeEvents {
    ...
    public static final BiomeEvent HEALING_ARROW_EVENT = register(Identifier.of("things-around", "forest/healing_arrow"), new HealingArrowForestEvent());
    public static final BiomeEvent FOREST_HARVEST_EVENT = register(Identifier.of("things-around", "forest/harvest"), new ForestHarvestEvent());
    public static final BiomeEvent FOREST_RAINY_DAY = register(Identifier.of("things-around", "forest/rainy_day"), new RainyDayForestEvent());
    public static final BiomeEvent FOREST_TOUGH_BARK_EVENT = register(Identifier.of("things-around", "forest/tough_bark"), new ToughBarkForestEvent());
